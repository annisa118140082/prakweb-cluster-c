<div class="testbox">
    <table class="table" cellpadding="25" cellspacing="0">
        ...
        include "koneksi.php";
        $conn = koneksi();
        $query = "SELECT mahasiswa.nim as nim, mahasiswa.nama as mhsnama, mahasiswa.angkatan as angkatan, jurusan.nama as jrsnama FROM mahasiswa LEFT JOIN jurusan ON mahasiswa.prodi = jurusan.id ORDER BY mahasiswa.nim ASC";
